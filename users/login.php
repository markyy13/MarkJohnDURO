        ...
        <div class="container">
            <div class="login-content">
                <div class="login-logo">
                    <a href="index.php">
                        <h2 style="color: #fff">VPRS Login</h2>
                    </a>
                </div>
                <div class="login-form">
                    <form method="post">
                        ...
                        <div class="form-group">
                           ...
                           <input type="text" name="emailcont" required="true" placeholder="Email or Contact Number" required="true" class="form-control">
                        </div>
                        <div class="form-group">
